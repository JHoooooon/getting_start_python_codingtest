...
"""
현재 책에 나온 솔루션이 혼란스럽다.
왜 1 ~ 100 까지의 각 언덕을 주어진 언덕과 비교하지?
...
"문제 내용이 1 ~ 100 까지의 언덕이 있으며, 주어진 언덕(각 라인의 언덕)과의
높이차가 17 이하 이어야 한다."
...
번역과정의 실수인지 모르겠지만, 솔루션 자체가 이해가 가지 않는다. 

둘중 하나이다. 내가 문제를 잘못이해하고 있는건지, 아니면 문제자체가 이상한건지
"""